...
export const en = {
  ...
  adminPanel: {
    ...
    products: {
      ...
      fieldImage: "Image",
      fieldImageUrl: "Image URL (primary)",
      uploadImage: "Upload image",
      uploading: "Uploading…",
      fieldImagesExtra: "Additional images",
      fieldImagesExtraHint: "Extra gallery photo URLs, one per line.",
      fieldSizes: "Sizes",
      fieldSizesHint: "Comma-separated, e.g. 34, 36, 38, 40.",
      fieldDescriptionEn: "Description (English)",
      fieldDescriptionPl: "Description (Polish)",
      fieldMaterialsEn: "Materials (English)",
      fieldMaterialsPl: "Materials (Polish)",
      fieldColorEn: "Colour (English)",
      fieldColorPl: "Colour (Polish)",
      fieldFeatured: "Featured",
      fieldNewArrival: "New arrival",
      fieldStock: "Stock",
      fieldStockHint: "Available units. 0 = sold out (hidden from shop).",
      fieldStockPerSize: "Stock per size",
      fieldStockPerSizeHint: "Add sizes above to set stock for each. 0 = that size is sold out.",
      soldOut: "Sold out",
      save: "Save",
      saving: "Saving…",
      cancel: "Cancel",
    ...
    orders: {
      ...
      refund: "Refund order",
      refundConfirm: "Refund this order in full? This cannot be undone.",
      refundingToast: "Refund requested — Stripe will confirm shortly.",
      refundFailed: "Refund could not be processed. Try again.",
    },
    subscribers: {
