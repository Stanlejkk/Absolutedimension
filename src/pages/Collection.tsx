    ...
    return (
      <section className="pt-40 pb-24">
        <div className="container-x text-center">
          ...
          <h1 className="font-display text-5xl font-light mb-6">Collection not found.</h1>
        ...
        <div className="absolute inset-0 flex items-end">
          <div className="container-x pb-10 md:pb-16 text-bone">
            <nav className="flex flex-wrap gap-2 text-xs tracking-wide text-bone/70 mb-4">
              ...
              <span>/</span>
              <Link to="/collections" className="hover:text-bone">Collections</Link>
              <span>/</span>
            ...
            >
              <p className="eyebrow text-bone/70 mb-3">Collection</p>
      ...
      <div className="container-x mt-16 md:mt-20">
        {pieces.length > 0 ? (
          ...
          <p className="text-center text-muted italic py-12">
            This collection is being composed. Check back soon.
          </p>
        )}
      </div>
